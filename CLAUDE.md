...
- `GMAIL_APP_PASSWORD` — senha de app de 16 caracteres (Google → Segurança →
  Senhas de app; exige verificação em duas etapas ativa)
...
O script envia via SMTP do Gmail com as imagens anexadas. Confirme o retorno
`EMAIL_ENVIADO_OK`.
